...
public class Clock extends Application{
    ...
    private static AudioClip AUDIO = new AudioClip(Resource.toUrl("/audio/clock-sound.wav", Clock.class));
    ...
    public void start(Stage stage){
        ...
        pane.getChildren().add(new CanvasPane(canvas, (w, h) -> {
            WIDTH = w;
            HEIGHT = h;
        }));
        ...
        stage.getIcons().add(new Image(Resource.toUrl("/images/icon.png", Clock.class)));
    ...
    private void update(GraphicsContext gc){
        ...
        gc.setFill(Color.WHITE);
        gc.setFont(FONT);
        gc.fillText(format(hours)+":"+format(minutes)+":"+format(seconds), 50, 100);
        gc.setFont(FONT_13);
